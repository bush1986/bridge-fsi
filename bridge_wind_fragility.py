...
def main(log_level: str = "INFO") -> None:
    ...
    flutter_cfg = cfg.get("flutter", {"case_dir": "flutter_cases", "wind_speeds": [20, 25, 30, 35, 40, 45, 50, 55, 60]})
    ...
    bridge_params = cfg.get("bridge_params", {
        "mass": 15000,
        "inertia": 3_000_000,
        "f_h": 0.10491093,
        "f_alpha": 0.12921779,
    ...
    u_cr, f_flut, _ = calculate_flutter_speed(flutter_df, bridge_params, speed_range)
    if u_cr:
